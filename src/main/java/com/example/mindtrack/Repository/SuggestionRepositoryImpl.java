 ...
 * .toList();
 * 
 * return Optional.of(new SuggestionPayload(id, base.get("userId"),
 * base.get("createdAt"), items));
 * }
 * 
 * @Override
 * public Optional<SuggestionPayload> findLatestSuggestionPayloadByUser(String
 * userId) {
